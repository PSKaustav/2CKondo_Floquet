#___2_______________________________________________________________________________________________________________
...
#__________________________________________________________________________________________________________________
# This file is the one where the floquet step is the one using suzuki trotter decomposition (which still doesnt match the previous work)
#==================================================================================================================
...
if no_floquet_steps > 0:
    ...
    for left in range(0, N-1, 2):
        psi_mps = build_fsim_gate(theta, left) @ psi_mps #theta

    for left in range(N+1, 2*N, 2):
        psi_mps = build_fsim_gate(theta, left) @ psi_mps #theta

    for left in range(1, N-1, 2):
        psi_mps = build_fsim_gate( 2*theta, left) @ psi_mps #2 * theta
...
plt.plot(range(no_floquet_steps+2), impurity_mag)
